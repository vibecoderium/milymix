...
export class PromptDjMidi extends LitElement {
  static override styles = css`
    ...
    #main-scroll-area { /* The scrollable part */
      ...
      padding: 1.5vmin;
      box-sizing: border-box;
      display: flex; /* Добавлено для центрирования кнопки */
      flex-direction: column; /* Добавлено для центрирования кнопки */
    ...
    #accordions-wrapper { /* Обертка для аккордеонов, чтобы они были одним блоком */
      display: flex;
      flex-direction: column;
      gap: 3px; /* Строгий отступ 3px между аккордеонами */
    }
  ...
  override render() {
    ...
    return html`
      ...
      <div id="bottom-panels-container">
        ...
        <div id="accordions-wrapper"> <!-- Обертка для аккордеонов -->
