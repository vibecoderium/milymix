...
export class ActivePromptsDisplay extends LitElement {
    static override styles = css`
        :host {
            ...
            padding: 0 1.5vmin; /* Удален верхний и нижний отступ, сохранен горизонтальный */
        ...
        .active-prompts-title {
            ...
            padding: 0; /* Удалены все отступы для заголовка */
        ...
        .knobs-wrapper {
            ...
            padding: 4.5vmin 4.5vmin 0 4.5vmin; /* Удален нижний отступ, сохранены остальные */
